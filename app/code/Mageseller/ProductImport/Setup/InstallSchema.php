...
namespace Mageseller\ProductImport\Setup;
...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $installer->getConnection()->rawQuery("ALTER TABLE `{$table}` ADD INDEX `CATALOG_PRODUCT_ENTITY_VARCHAR_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`)");
