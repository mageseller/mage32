<?php
namespace Mageseller\LeadersystemsImport\Helper\Product\Import;
...
*/
        $process = $this->processFactory->create()
            ->setType('Leadersystems products import')
            ->setStatus(ProcessModel::STATUS_PENDING)
            ->setName('Leadersystems products import')
            ->setParams([$since])
            ->setHelper(LeadersystemsHandler::class)
            ->setMethod('importLeadersystemsProducts');
