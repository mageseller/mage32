<?php
namespace Mageseller\Process\Model\ResourceModel;

use Magento\Framework\Model\AbstractModel;
use Magento\Framework\Model\ResourceModel\Db\AbstractDb;
use Mageseller\Process\Model\ResourceModel\ArraySerializableFieldsTrait;
...
class Process extends AbstractDb
{
    ...
    protected function _construct()
    {
        ...
        $this->_init('mageseller_process', 'id');
    }
    ...
    /**
     * Truncate mageseller_process table
     */
