...
use Mageseller\SupplierImport\Api\XitCategoryRepositoryInterface;
use Mageseller\SupplierImport\Api\Data\XitCategorySearchResultsInterfaceFactory;
...
use Mageseller\SupplierImport\Model\ResourceModel\XitCategory as ResourceXitCategory;
use Mageseller\SupplierImport\Model\ResourceModel\XitCategory\CollectionFactory as XitCategoryCollectionFactory;
...
class XitCategoryRepository implements XitCategoryRepositoryInterface
{
    ...
    public function save(
        ...
        $xitCategoryData = $this->extensibleDataObjectConverter->toNestedArray(
            $xitCategory,
            [],
            \Mageseller\SupplierImport\Api\Data\XitCategoryInterface::class
        );
