...
class Edit extends \Mageseller\SupplierImport\Controller\Adminhtml\XitCategory
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Mageseller\SupplierImport\Model\XitCategory::class);
        ...
        $this->_coreRegistry->register('mageseller_supplierimport_xitcategory', $model);
