...
namespace Mageseller\IngrammicroImport\Controller\Adminhtml\Ingrammicro;
...
class Importcategory extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Mageseller\Ingrammicro\Helper\Ingrammicro
     */
    ...
    public function __construct(
        ...
        $this->logger = $ingrammicroimportLogger;
    ...
    public function execute()
    {
        try {
            $result = [];
            $response = $this->ingrammicroHelper->importIngrammicroCategory();
            $result['status'] = 1;
