        ...
        $.widget(
            'mage.categorymap', {
                ...
                _bind: function () {
                    ...
                    $('.supplier-category').find("li a").live(
                        'click', function () {
                    ...
                    $('.shop-category-body').find("li .shop-category-li").live(
                        'click', function () {
                            $("#shop_input").val($(this).html().trim().replace("&amp;", "&"));
                            $("#shop_input_id").val($(this).data("id"));
                        }
                    );
                    $('#use_as_attribute').live(
                        'click', function () {
