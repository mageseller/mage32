...
{
    /**
     * @var \Mageseller\Customization\Model\ResourceModel\Category\Collection
     */
    ...
    public function __construct(
        ...
        \Mageseller\Customization\Model\ResourceModel\Category\Collection $collectionFactory,
        array $data = []
    ) {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            [
                'label'   => __('Delete'),
                'url'     => $this->getUrl('devices/*/massDelete'),
    ...
    {
        return $this->getUrl('devices/*/index', ['_current' => true]);
    }
