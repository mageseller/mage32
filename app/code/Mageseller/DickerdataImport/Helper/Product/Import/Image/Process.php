<?php
namespace Mageseller\DickerdataImport\Helper\Product\Import\Image;
...
*/
        $process = $this->processFactory->create()
            ->setType('Dicker Data image import')
            ->setStatus(ProcessModel::STATUS_PENDING)
            ->setName('Dicker Data  image import')
            ->setParams([$since])
            ->setHelper(DickerdataHandler::class)
            ->setMethod('importDickerdataImages');
