...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(
        ...
        $installer->getConnection()->rawQuery("ALTER TABLE `{$setup->getTable('mageseller_dickerdataimport_dickerdatacategory')}` ADD UNIQUE `{$indexName}` (`name`(255),`parent_name`(255))");
    }
